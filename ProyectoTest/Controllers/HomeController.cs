...
namespace ProyectoTest.Controllers
{
    public class HomeController : Controller
    {
        ...
        public JsonResult GuardarProducto(string objeto, HttpPostedFileBase imagenArchivo)
        {
            ...
            QRCodeData qrCodeData = qrGenerator.CreateQrCode(imagenArchivoQr.ContentType, QRCodeGenerator.ECCLevel.Q);
        ...
        //HttpPostedFileBase(new MemoryStream(QRbyte), contentTypeFile, fileName);
            ...
            try
            {
                ...
                ///////////////////
                /*string GuardarEnRutaQR = "~/Imagenes/qrs/";
                string physicalPathQR = Server.MapPath("~/Imagenes/qrs");*/
                ...
                if (imagenArchivo != null && oProducto.IdProducto != 0)
                {
                    ...
                    /*string extension2 = Path.GetExtension(imagenArchivoQr.FileName);
                    GuardarEnRutaQR = GuardarEnRutaQR + oProducto.IdProducto.ToString() + extension2;
                    oProducto.RuraQr = GuardarEnRutaQR;

                    QRbyte2.SaveAs(physicalPathQR + "/" + oProducto.IdProducto.ToString() + extension2);*/
